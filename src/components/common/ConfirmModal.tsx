  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-[372px] min-h-[226px] h-auto bg-white rounded-[22px] px-[24px] pt-[40px] pb-[28px] flex flex-col items-center gap-[8px] shadow-[0_16px_40px_rgba(0,0,0,0.2)]"
      >
