              ...
              isWrite ? (
                ...
                <div className="flex flex-col items-center">
                  <div className="text-center">
                    ...
                    <div className="text-[var(--color-primary)] font-bold">{question}</div>
                  </div>
                  <button
                    onClick={() => navigate('/diary/new')}
                    className="mt-2 rounded-full bg-[var(--color-primary)] w-10 h-10 shrink-0 flex items-center justify-center"
                  >
